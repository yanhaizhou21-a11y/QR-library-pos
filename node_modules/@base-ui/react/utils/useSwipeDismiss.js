...
var _getElementTransform = require("./getElementTransform");
...
function useSwipeDismiss(options) {
  ...
  function findGestureScrollableTouchTarget(target, root) {
    ...
    const find = axis => {
      const scrollTarget = (0, _scrollable.findScrollableTouchTarget)(target, root, axis);
      const doc = (0, _owner.ownerDocument)(scrollTarget);

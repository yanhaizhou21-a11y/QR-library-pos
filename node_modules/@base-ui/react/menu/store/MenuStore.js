...
function createNullMenuStore() {
  const triggerElements = new _popups.PopupTriggerMap();
  const store = new _NullStore.NullStore(Object.freeze(createInitialState(triggerElements)), Object.freeze(createInitialContext(triggerElements)), selectors);
...
function createInitialState(triggerElements, floatingId, nested = false, initialState) {
  return {
    ...(0, _popups.createInitialPopupStoreState)(triggerElements, floatingId, nested),
    disabled: false,
    modal: true,
    openMethod: null,

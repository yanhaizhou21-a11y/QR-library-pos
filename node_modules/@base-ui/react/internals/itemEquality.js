...
exports.isSelectedValueDirty = isSelectedValueDirty;
exports.removeItem = removeItem;
exports.resolveSelectedIndex = resolveSelectedIndex;
...
function isSelectedValueDirty(currentValue, initialValue, comparer) {
  if (Array.isArray(currentValue) && Array.isArray(initialValue)) {
    return !(0, _areArraysEqual.areArraysEqual)(currentValue, initialValue, (itemValue, initialItemValue) => compareItemEquality(itemValue, initialItemValue, comparer));
  }

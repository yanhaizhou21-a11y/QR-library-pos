 ...
 */
export declare const hovering = "data-hovering";
/**
 ...
 */
export declare const hasOverflowX = "data-has-overflow-x";
/**
 * Present when the scroll area content is taller than the viewport.
 */
export declare const hasOverflowY = "data-has-overflow-y";
/**
 * Present when there is overflow on the horizontal start side.
 */
export declare const overflowXStart = "data-overflow-x-start";
/**
 * Present when there is overflow on the horizontal end side.
 */
export declare const overflowXEnd = "data-overflow-x-end";
/**
 * Present when there is overflow on the vertical start side.
 */
export declare const overflowYStart = "data-overflow-y-start";
/**
 * Present when there is overflow on the vertical end side.
 */
export declare const overflowYEnd = "data-overflow-y-end";
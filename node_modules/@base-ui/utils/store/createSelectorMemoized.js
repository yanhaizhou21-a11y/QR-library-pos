...
exports.createSelectorMemoizedWithOptions = exports.createSelectorMemoized = void 0;
 ...
 */
const createSelectorMemoizedWithOptions = options => {
  ...
  if (options !== undefined) {
    ...
    } else if (typeof memoizeOptions === 'object' && memoizeOptions !== null && !Array.isArray(memoizeOptions)) {
